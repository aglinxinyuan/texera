...
public class User extends TableImpl<UserRecord> {
     ...
     */
    public final TableField<UserRecord, UserRoleEnum> ROLE = createField(DSL.name("role"), SQLDataType.VARCHAR.nullable(false).defaultValue(DSL.field("'INACTIVE'::texera_db.user_role_enum", SQLDataType.VARCHAR)).asEnumDataType(org.apache.texera.dao.jooq.generated.enums.UserRoleEnum.class), this, "");
    ...
    /**
     * The column <code>texera_db.user.account_creation_time</code>.
     */
    public final TableField<UserRecord, OffsetDateTime> ACCOUNT_CREATION_TIME = createField(DSL.name("account_creation_time"), SQLDataType.TIMESTAMPWITHTIMEZONE(6).nullable(false).defaultValue(DSL.field("now()", SQLDataType.TIMESTAMPWITHTIMEZONE)), this, "");
