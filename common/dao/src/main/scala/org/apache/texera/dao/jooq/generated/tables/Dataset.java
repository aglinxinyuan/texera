...
public class Dataset extends TableImpl<DatasetRecord> {
    ...
    /**
     * The column <code>texera_db.dataset.repository_name</code>.
     */
    public final TableField<DatasetRecord, String> REPOSITORY_NAME = createField(DSL.name("repository_name"), SQLDataType.VARCHAR(128), this, "");
