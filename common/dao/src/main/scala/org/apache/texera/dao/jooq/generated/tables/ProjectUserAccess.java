...
public class ProjectUserAccess extends TableImpl<ProjectUserAccessRecord> {
     ...
     */
    public final TableField<ProjectUserAccessRecord, PrivilegeEnum> PRIVILEGE = createField(DSL.name("privilege"), SQLDataType.VARCHAR.nullable(false).defaultValue(DSL.field("'NONE'::texera_db.privilege_enum", SQLDataType.VARCHAR)).asEnumDataType(org.apache.texera.dao.jooq.generated.enums.PrivilegeEnum.class), this, "");
