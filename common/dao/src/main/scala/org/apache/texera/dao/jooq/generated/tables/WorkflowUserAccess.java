...
public class WorkflowUserAccess extends TableImpl<WorkflowUserAccessRecord> {
     ...
     */
    public final TableField<WorkflowUserAccessRecord, PrivilegeEnum> PRIVILEGE = createField(DSL.name("privilege"), SQLDataType.VARCHAR.nullable(false).defaultValue(DSL.field("'NONE'::texera_db.privilege_enum", SQLDataType.VARCHAR)).asEnumDataType(org.apache.texera.dao.jooq.generated.enums.PrivilegeEnum.class), this, "");
